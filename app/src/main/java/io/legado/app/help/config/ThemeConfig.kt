...
object ThemeConfig {
    ...
    fun saveDayTheme(context: Context, name: String) {
        val primary =
            context.getPrefInt(PreferKey.cPrimary, context.getCompatColor(R.color.md_light_background))
        val accent =
    ...
    fun applyTheme(context: Context) = with(context) {
        when {
            ...
            AppConfig.isNightTheme -> {
                ...
                val primary =
                    getPrefInt(PreferKey.cPrimary, getCompatColor(R.color.md_light_background))
                val accent =
